...
function RootLayoutInner() {
  ...
  useEffect(() => {
    ...
    // lesson-pay: 레슨비 무설치 납부 페이지(공개 링크 — 수강생이 로그인 없이 연다).
    const inPrivacy = seg[0] === 'privacy' || seg[0] === 'delete-account' || seg[0] === 'guest-apply' || seg[0] === 'guest-chat' || seg[0] === 'discover' || seg[0] === 'map' || seg[0] === 'lesson-pay';
    ...
    <GestureHandlerRootView style={rootStyles.flex}>
      <ErrorBoundary>
        ...
        <Stack screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen name="lab/lessons" options={transitions.slideFromRight} />
          <Stack.Screen name="guest-apply" options={transitions.fadeScale} />
          <Stack.Screen name="lesson-pay" options={transitions.fadeScale} />
          ...
          <Stack.Screen name="club/[id]/lesson/[offerId]" options={transitions.slideFromRight} />
          <Stack.Screen name="club/[id]/guest-inbox" options={transitions.slideFromRight} />
          ...
          <Stack.Screen name="market/invites" options={transitions.slideFromRight} />
          <Stack.Screen name="market/bookmarks" options={transitions.slideFromRight} />
