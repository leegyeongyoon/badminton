...
const styles = StyleSheet.create({
  ...
  newLink: { fontSize: 13, fontWeight: '800' },
  ...
  card: { flexDirection: 'row', alignItems: 'center', gap: spacing.md, borderRadius: 16, padding: spacing.lg, marginBottom: spacing.sm + 2 },
  headRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  cardTitle: { fontSize: 15.5, fontWeight: '800', flexShrink: 1 },
  closedTag: { fontSize: 11, fontWeight: '800' },
  ...
  newBadgeText: { color: '#fff', fontSize: 10.5, fontWeight: '900' },
});
