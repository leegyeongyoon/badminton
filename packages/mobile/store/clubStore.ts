...
interface ClubState {
  ...
  createClub: (name: string, clubType?: 'CLUB' | 'MEETUP', homeFacilityId?: string) => Promise<void>;
...
export const useClubStore = create<ClubState>((set) => ({
  ...
  createClub: async (name, clubType, homeFacilityId) => {
    await clubApi.create(name, clubType ?? 'CLUB', homeFacilityId);
  },
